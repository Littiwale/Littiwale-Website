...
(function() {
  ...
  window.openReceiptPrinterModal = function(orderData) {
    ...
    const custAddress = isTakeaway ? '🛍️ Pickup Location: Littiwale Cloud Kitchen, Ward No. 7, Punjabi Para, Barbil' : (orderData.customerAddress || orderData.deliveryAddress || orderData.address || 'ADDRESS NOT PROVIDED - CALL CUSTOMER BEFORE DISPATCH');
